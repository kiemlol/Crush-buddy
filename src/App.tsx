...
const THEMES = [
  { id: 'mint', label: 'Bạc hà', class: '', color: 'bg-mint-500' },
  { id: 'rose', label: 'Hồng đào', class: 'theme-rose', color: 'bg-rose-400' },
  { id: 'sky', label: 'Xanh trời', class: 'theme-sky', color: 'bg-sky-400' },
  { id: 'violet', label: 'Oải hương', class: 'theme-violet', color: 'bg-purple-400' },
  { id: 'amber', label: 'Hổ phách', class: 'theme-amber', color: 'bg-orange-400' },
];
...
export default function App() {
  ...
  return (
    <div className={`min-h-screen bg-mint-50 font-sans text-slate-700 selection:bg-pink-soft pb-20 ${activeThemeClass}`}>
